...
export class UpdateSchema1753105533821 implements MigrationInterface {
    name = 'UpdateSchema1753105533821'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`is_verified\` tinyint NULL DEFAULT 0`);
        ...
        await queryRunner.query(`ALTER TABLE \`student_educations\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`student\` DROP FOREIGN KEY \`FK_d0b389a82cc35e961a123e025e1\``);
        await queryRunner.query(`ALTER TABLE \`student\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`student\` CHANGE \`districtId\` \`districtId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`student\` CHANGE \`districtId\` \`districtId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`student\` CHANGE \`gender\` \`gender\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`student\` CHANGE \`birth_date\` \`birth_date\` datetime NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`student\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`student\` ADD CONSTRAINT \`FK_d0b389a82cc35e961a123e025e1\` FOREIGN KEY (\`districtId\`) REFERENCES \`district\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`student_educations\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`district\` CHANGE \`provinceId\` \`provinceId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`district\` ADD CONSTRAINT \`FK_23a21b38208367a242b1dd3a424\` FOREIGN KEY (\`provinceId\`) REFERENCES \`province\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`student_educations\` ADD \`provinceId\` int NULL DEFAULT 'NULL'`);
